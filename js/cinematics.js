export class CinematicsManager {
            ...
            intro: {
                ...
                scenes: [
                    ...
                    },
                    {
                        ...
                        text: "Como piloto de élite de la nave experimental Star Soldier, tu misión es enfrentar esta amenaza y descubrir sus intenciones.",
                        duration: 6000
                    }
                ]
            },
    ...
    createScene3D(sceneId) {
        ...
        switch (sceneId) {
            ...
            case "Como piloto de élite de la nave experimental Star Soldier, tu misión es enfrentar esta amenaza y descubrir sus intenciones.":
